...
class SpellingChecker:
    ...
    UZBEK_LATIN_DICT = {
        ...
        'президент', 'вазир', 'ҳоким', 'қўмита', 'агентлик',
        'республика', 'вилоят', 'туман', 'шаҳар', 'қишлоқ', 'маҳалла',
        # Add common words mistakenly flagged as errors
        'фойдаланишдаги', 'контракт', 'контрактларни', 'кечиккани',
        'рекультивация', 'жавобгардир', 'тугаллангунгача', 'спецификацияларга',
        'корректировка', 'дан', 'нинг', 'ҳамда', 'поябзал',
        
        # Common Russian Legal/Business Terms (Whitelist to avoid errors)
        'товара', 'договора', 'при', 'случае', 'дней', 'согласно', 'течение', 
        'недостатков', 'для', 'поставки', 'счет', 'срока', 'его', 'договору', 
        'документа', 'заказчик', 'после', 'качеству', 'условиях', 'порядке', 
        'также', 'обязан', 'момента', 'обязательств', 'либо', 'услуг', 'размере', 
        'республики', 'должен', 'качества', 'сторон', 'дальнейшем', 'лице', 
        'имеет', 'право', 'этом', 'банковских', 'другой', 'средств', 'стоимость', 
        'стоимости', 'директора', 'электронной', 'действия', 'наличии', 'поставка',
        'будет', 'часть', 'года', 'исполнения', 'акта', 'составляет', 'оплатить', 'вправе',
        'чем', 'спецификации', 'каждой', 'лице', 'спрока', 'банковских',
        'заменить', 'просрочки', 'обстоятельств', 'заказчика',
        'именуемое', 'оплачивает', 'сторонами', 'mailto',
        'ортик', 'куриш', 'электронного', 'тижорат', 'сифат', 'назорат'
    }
    ...
    UZBEK_CORRECTIONS = {
        ...
        # Derived from Bulk Analysis (Correction Map)
        'мувофик': 'мувофиқ',
        'тулик': 'тўлиқ',
        'нуксонлар': 'нуқсонлар',
        'хукукига': 'ҳуқуқига',
        ...
        'йули': 'йўли',
        'ўзил': 'ўз',
        'спецификацияларга': 'спецификацияларга', # Valid
        'тугаллангунгача': 'тугаллангунгача', # Valid
        'жавобгардир': 'жавобгардир', # Valid
