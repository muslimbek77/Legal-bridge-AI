...
export default function ContractUploadPage() {
  ...
  const uploadMutation = useMutation({
    ...
    onError: (error) => {
      toast.error(error.response?.data?.detail || 'Yuklashda xatolik yuz berdi')
    },
  })
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Yangi shartnoma yuklash</h1>
        <p className="mt-1 text-sm text-gray-500">
          Shartnomani yuklang va avtomatik tahlil qilish uchun ma'lumotlarni to'ldiring
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="card p-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Fayl yuklash</h3>
          <FileUpload
            files={files}
        ...
        <div className="card p-6">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            {/* Counterparty INN */}
            <div>
              <label htmlFor="counterparty_inn" className="block text-sm font-medium text-gray-700">
                Kontragent INN
              </label>
              <input
                type="text"
            ...
            <div className="sm:col-span-2">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="auto_analyze" className="ml-2 block text-sm text-gray-900">
